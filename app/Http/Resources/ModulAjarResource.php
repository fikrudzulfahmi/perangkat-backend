...
class ModulAjarResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'identifikasi_murid' => $this->identifikasi_murid,
            'analisis_materi' => $this->analisis_materi,
            'capaian_pembelajaran' => $this->capaian_pembelajaran,
            'kemitraan' => $this->kemitraan,
            'lingkungan_belajar' => $this->lingkungan_belajar,
            'pemanfaatan_digital' => $this->pemanfaatan_digital,
